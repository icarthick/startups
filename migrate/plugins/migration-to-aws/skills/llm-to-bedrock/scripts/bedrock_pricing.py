...
# Every row below was re-verified against that cache on 2026-09-19; Sonnet 4.6 and
# Opus 4.8 IDs updated to current versionless form per AWS model-card docs.
