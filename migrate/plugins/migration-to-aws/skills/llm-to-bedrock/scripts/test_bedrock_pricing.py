...
def test_static_fallback_sonnet_5_rate_is_3_and_15_per_1m():
    """Sonnet 5 introductory pricing ($2/$10 per 1M) expired Aug 31, 2026; standard rate is $3/$15.
    Assert both bare id and the us. cross-region inference profile — see pricing-cache.md."""
    for model_id in ("anthropic.claude-sonnet-5",
