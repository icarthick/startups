...
└── references/vendored/                        # byte-synced copies of skills/shared/ — DO NOT EDIT
    ...
    └── ai/                                     # plugin-neutral, source-cloud-agnostic AI content
        ...
        └── sdk-capability-map.json             # SDK method → capability lookup (discover-app-code.md)
```
