...
control to `design.md`, ensure `aws-design.json` exists and satisfies the Output
...
a valid `aws-design.json`, stop and report it so the phase gate fails cleanly rather
