...
Attempt to reach aws-mcp with **up to 2 retries** (3 total attempts):
...
- **If cache > 90 days and MCP unavailable**: "⚠️ Pricing source: stale cache only (updated [date]). The aws-mcp server is unreachable. Proceeding with cached pricing; accuracy may be ±15-25% for AI models."
