...
the `aws-pricing-calculator` MCP (removed — capability gap), always `null` for now.
See open question in `setup.md`. AWS regional prices should be verified directly at calculator.aws.
