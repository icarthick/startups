...
> Schema for Render what-if workshop snapshots under `$MIGRATION_DIR/scenarios/`.
...
```
$MIGRATION_DIR/
├── render-resource-inventory.json   # FROZEN — workshop never rewrites
...
"workshop": {
  ...
  "last_sheet_at": "2026-09-19T20:00:00Z",
...
```json
{
  ...
  "active_scenario_id": "scenario-002",
  "max_scenarios": 5,
  "inventory_fingerprint": "<sha256 hex of render-resource-inventory.json>",
  "scenarios": [
    {
...
MUST recompute the fingerprint of `render-resource-inventory.json` and abort with
