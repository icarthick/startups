...
Collects user feedback. Reuses the shared feedback infrastructure (trace builder) adapted for render-to-aws's flat resource model. (Plan-share links are GATED OFF until the landing page ships — see `feedback-collect.md` Step 3.)
