...
1. Preconditions above must pass. Do **not** re-run Discover / live CLI / render.yaml parse.
...
When Estimate offer **[B] Proceed to Generate** is chosen, do not enter this
