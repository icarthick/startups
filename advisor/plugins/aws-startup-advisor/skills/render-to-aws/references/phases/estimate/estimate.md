...
_preconditions:
  ...
  - _check_single_active_phase: true
    _on_failure: _halt_and_inform
  - _check_file_exists: [aws-design.json, preferences.json, render-resource-inventory.json]
...
Calculate projected monthly AWS costs for the designed Render-to-AWS architecture,
...
**Your ONLY job: Show the financial picture of moving from Render to AWS. Nothing else.**
