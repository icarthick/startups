...
# had been copied from Opus 4.1's legacy $15/$75 and was corrected to $5/$25 (2026-08-04);
# Sonnet 5 introductory pricing ($2/$10) ended Aug 31 2026; standard rate $3/$15 now applies.
...
STATIC_FALLBACK = {
    ...
    "anthropic.claude-opus-4-6-v1":                  {"input_per_1k_usd": 0.005, "output_per_1k_usd": 0.025},
    "us.anthropic.claude-opus-4-6-v1":               {"input_per_1k_usd": 0.005, "output_per_1k_usd": 0.025},
    "anthropic.claude-opus-4-5-20251101-v1:0":       {"input_per_1k_usd": 0.005, "output_per_1k_usd": 0.025},
    "us.anthropic.claude-opus-4-5-20251101-v1:0":    {"input_per_1k_usd": 0.005, "output_per_1k_usd": 0.025},
    "anthropic.claude-sonnet-4-5-20250929-v1:0":     {"input_per_1k_usd": 0.003, "output_per_1k_usd": 0.015},
    "us.anthropic.claude-sonnet-4-5-20250929-v1:0":  {"input_per_1k_usd": 0.003, "output_per_1k_usd": 0.015},
