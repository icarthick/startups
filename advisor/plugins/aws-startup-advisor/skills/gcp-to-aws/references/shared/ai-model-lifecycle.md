...
## Legacy / EOL Models (as of September 20, 2026)
...
| --------------- | ----------------------------------------- | ------------ | ----------- | ------------ | --------------------------- |
| Nova Canvas v1  | `amazon.nova-canvas-v1:0`                 | Sep 30, 2026 | 10          | **excluded** | Stability AI (see note)     |
| Nova Reel v1    | `amazon.nova-reel-v1:0` / `v1:1`          | Sep 30, 2026 | 10          | **excluded** | —                           |
| Claude Sonnet 4 | `anthropic.claude-sonnet-4-20250514-v1:0` | Oct 14, 2026 | 24          | **excluded** | Claude Sonnet 4.5 / 4.6 / 5 |
| Jamba 1.5 Large | `ai21.jamba-1-5-large-v1:0`               | Nov 26, 2026 | 67          | **excluded** | —                           |
| Jamba 1.5 Mini  | `ai21.jamba-1-5-mini-v1:0`                | Nov 26, 2026 | 67          | **excluded** | —                           |
| Claude Opus 4.1 | `anthropic.claude-opus-4-1-20250805-v1:0` | Jan 8, 2027  | 110         | legacy       | Claude Opus 4.6 / 4.8       |

**Removed (past EOL as of Sep 20, 2026):**
...
- Command R / R+ (`cohere.command-r-v1:0` / `plus`) — EOL Aug 19, 2026
- Claude 3 Haiku (`anthropic.claude-3-haiku-20240307-v1:0`) — EOL Sep 10, 2026
- Nova Premier v1 (`amazon.nova-premier-v1:0`) — EOL Sep 14, 2026 (use Nova 2 Pro)
- Nova Sonic v1 (`amazon.nova-sonic-v1:0`) — EOL Sep 14, 2026 (use Nova 2 Sonic)
