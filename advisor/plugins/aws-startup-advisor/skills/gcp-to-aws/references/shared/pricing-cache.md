...
| Claude Opus 5.5 | anthropic.claude-opus-5-5 | Anthropic | 4.00 | 20.00 | 1M | premium | active (CONFIRMED: platform.claude.com/docs, 2026-09-23) |
...
> Opus 4.8, and Opus 5.5 are NOT on that table** — Sonnet 5, Opus 4.8, and Opus 5.5's batch cells below are **unverified (‡)**:
> do not build a batch-discount TCO on them; price on-demand and note batch as a possible future saving pending the docs table listing them.
...
| Claude Opus 5.5 | 2.00 ‡ | 10.00 ‡ | 5.00 | 8.00 ‡ | 0.20 |
...
‡ Not listed on the batch-supported models table as of 2026-09-23 — rate is the standard 50%-of-on-demand
...
from the Bedrock pricing page first. Claude Opus 5.5's 1h cache-write rate ($8.00) is also a ‡ projection (1.25× the
5m rate × the 5m/1h multiplier from analogous models; the Bedrock pricing page was not fully machine-readable to confirm).
